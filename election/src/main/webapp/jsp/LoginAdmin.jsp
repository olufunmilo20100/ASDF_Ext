...
try
{
	...
	if(request.getParameter("btn_login")!=null) //check login button click event not null
	{
		...
		if(rs.next())
		{
			...
			{
				session.setAttribute("login","Admin"); //session name is login and store fetchable database username
				response.sendRedirect("AdminPage.jsp"); //after login success redirect to welcome.jsp page
			}
		}
		else
		{
			request.setAttribute("errorMsg","Login with Admin Access"); //invalid error message for email or password wrong
		}
